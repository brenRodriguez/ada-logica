...
if(puntos>=canje){
	console.log("Se lleva su producto")
		...
		(puntos>=canje*0.5 && premium== false){
	pesos= (canje-puntos)/3;
	console.log("Usted podra completar su canje con $"+ pesos + ".-")
}
	else if
		(puntos>=canje*0.5 && premium== true){
	pesos= (canje-puntos)/5;
	console.log("Usted podra completar su canje con $"+ pesos + ".-")
}
else{
	console.log("Sus puntos no le alcanzan, lo sentimos")
}
...
/*
muestra por consola el numero 4
var x=1;
while(x<=3){
	console.log("x");
	x++;}
